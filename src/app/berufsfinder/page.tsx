...
export const metadata: Metadata = {
  ...
  description:
    'Der KI-Berufsfinder von Berufsgenie analysiert deine Persönlichkeit und empfiehlt dir passende Berufe. 20 Fragen, 5 Minuten, deine Top 3 Berufe. Bald in der Genie App.',
  alternates: { canonical: '/berufsfinder' },
  openGraph: {
    title: 'KI-Berufsfinder – Finde den perfekten Job | Berufsgenie',
    description:
      'Beantworte 20 Fragen und erhalte personalisierte Berufsempfehlungen basierend auf deiner Persönlichkeit. Kostenlos in der Genie App.',
    url: 'https://berufsgenie.de/berufsfinder',
  },
  twitter: {
    card: 'summary_large_image',
    title: 'KI-Berufsfinder – Finde den perfekten Job | Berufsgenie',
    description:
      'Beantworte 20 Fragen und erhalte personalisierte Berufsempfehlungen. Kostenlos in der Genie App.',
  },
};
...
const steps = [
  ...
  },
  {
    ...
    duration: 'Sofort',
    description:
      'Basierend auf deinem Profil bekommst du deine persönlichen Top 3 Berufe – mit Erklärung, warum sie zu dir passen, plus Gehalt und Karrierechancen.',
  },
];
...
const features = [
  ...
  },
  {
    ...
    description:
      'Erhalte deine persönlichen Top 3 Berufe mit detaillierten Infos zu Aufgaben, Gehalt, Branchen und Karrieremöglichkeiten.',
  ...
  },
  {
    ...
    description:
      'Direkt nach der Analyse zeigen wir dir offene Stellenangebote, die zu deinen Empfehlungen passen – in deiner Region.',
  ...
  },
  {
    ...
    description:
      'Teile dein Ergebnis mit Freunden oder Kollegen. Vergleicht eure Persönlichkeitstypen und entdeckt gemeinsam neue Karrierewege.',
...
export default function BerufsinderPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFFBF5]">
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-amber-500 via-orange-500 to-orange-600 pt-28 pb-20 relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-lg sm:text-xl text-amber-100 mb-4 max-w-2xl">
              Finde den perfekten Job – in nur 5 Minuten. Unsere KI analysiert deine
              Persönlichkeit und zeigt dir, welcher Beruf wirklich zu dir passt.
            </p>
            <p className="text-base text-amber-200 mb-8 max-w-2xl">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 rounded-full bg-amber-100 px-4 py-1.5 text-sm text-amber-700 mb-6">
            ...
            <p className="text-lg text-stone-600 max-w-2xl mx-auto">
              Vom ersten Klick bis zur Berufsempfehlung – der KI-Berufsfinder führt dich in
              drei einfachen Schritten zu deinem Traumjob.
            </p>
          </div>
            ...
            {steps.map((step, index) => (
              <div key={step.title} className="relative">
                {index < steps.length - 1 && (
                  <div className="hidden md:block absolute top-16 left-[60%] w-[80%] border-t-2 border-dashed border-amber-200" />
                )}
                <div className="bg-[#FFFBF5] rounded-2xl p-8 border border-amber-100 hover:border-amber-300 hover:shadow-lg transition-all relative">
                  <div className="flex items-center gap-4 mb-6">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-2xl bg-gradient-to-br from-amber-500 to-orange-600 text-white">
                      <step.icon className="h-7 w-7" />
                    </div>
                    <div>
                      <span className="text-xs font-bold text-amber-500 uppercase tracking-wider">Schritt {step.number}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature) => (
              <div
                key={feature.title}
                className="bg-white rounded-2xl p-6 border border-amber-100 hover:border-amber-300 hover:shadow-lg transition-all"
              >
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-4">
              {[
                ...
                'Für alle Karrierestufen – vom Berufseinsteiger bis zum Wechsler',
                'Berücksichtigt über 300 Berufe und Karrierewege in Deutschland',
                ...
                <div key={item} className="flex items-start gap-3 bg-[#FFFBF5] rounded-xl p-4 border border-amber-100">
