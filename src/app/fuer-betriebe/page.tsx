...
export const metadata: Metadata = {
  title: 'Berufsgenie für Betriebe – Mitarbeiter finden per Video & Matching',
  description:
  ...
  openGraph: {
    title: 'Mitarbeiter finden per Video & Matching | Berufsgenie für Betriebe',
    description:
    ...
    url: 'https://berufsgenie.de/fuer-betriebe',
    type: 'website',
  },
  twitter: {
...
export default function FuerBetriebePage() {
  ...
  const webPageJsonLd = {
    '@context': 'https://schema.org',
    '@type': 'WebPage',
    name: 'Berufsgenie für Betriebe – Mitarbeiter finden per Video & Matching',
    description:
    ...
    <>
      ...
      <main className="min-h-screen">
        ...
        <section className="relative bg-gray-900 pt-28 pb-20 overflow-hidden">
          <div className="absolute inset-0 bg-gradient-to-br from-violet-900/40 via-gray-900 to-pink-900/30" />
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                <div className="inline-flex items-center gap-2 rounded-full bg-violet-500/20 border border-violet-500/30 px-4 py-1.5 text-sm text-violet-300 mb-6">
                ...
                <div className="mt-10 flex flex-col sm:flex-row gap-4">
                  <Link
                    ...
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-gradient-to-r from-violet-600 to-pink-600 px-8 py-4 text-base font-semibold text-white hover:from-violet-500 hover:to-pink-500 transition-all shadow-lg shadow-violet-500/25"
                  >
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  <div
                    key={card.label}
                    className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:border-violet-500/30 transition-colors"
                  >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
                Warum klassisches Mitarbeiter-Recruiting nicht mehr funktioniert
              </h2>
        ...
        <section className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
                Alles, was Sie für erfolgreiches Mitarbeiter-Recruiting brauchen
              </h2>
              <p className="mt-4 text-lg text-gray-600 max-w-3xl mx-auto">
              ...
              {[
                ...
                <div key={item.title} className="relative text-center group">
                  <div className="mx-auto mb-6">
                    <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-violet-600 to-pink-600 text-white flex items-center justify-center mx-auto shadow-lg shadow-violet-500/20 group-hover:shadow-xl group-hover:shadow-violet-500/30 transition-shadow">
              ...
              {[
                ...
                <div
                  ...
                  className={`rounded-2xl p-8 flex flex-col ${
                    plan.highlighted
                      ? 'bg-gradient-to-br from-violet-600 to-pink-600 text-white ring-4 ring-violet-200 scale-[1.03] shadow-2xl'
                      : 'bg-white border border-gray-200 shadow-sm'
                  }`}
                >
                  {plan.highlighted && (
                    <div className="text-xs font-semibold uppercase tracking-wide text-violet-200 mb-2">
                      Empfohlen
                    </div>
                  )}
                  <h3
                  ...
                  <p className="mt-6">
                    ...
                    {plan.period && (
                      <span
                        className={`text-sm ml-1 ${plan.highlighted ? 'text-violet-200' : 'text-gray-500'}`}
                      >
                        {plan.period}
                      </span>
                    )}
        ...
        <section className="py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl sm:text-4xl font-bold text-gray-900">
                Warum Betriebe Berufsgenie vertrauen
              </h2>
            </div>
        ...
        <section className="py-20 bg-gradient-to-br from-violet-600 via-purple-600 to-pink-600 relative overflow-hidden">
          ...
          <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="https://dashboard.berufsgenie.de/login"
                className="inline-flex items-center gap-2 rounded-full bg-white px-10 py-4 text-base font-semibold text-violet-600 hover:bg-gray-100 transition-colors shadow-lg"
              >
