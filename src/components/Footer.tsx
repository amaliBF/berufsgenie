      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-8">
          ...
          <div className="col-span-2 md:col-span-3 lg:col-span-2">
            ...
            <p className="text-sm mb-4 leading-relaxed">
              Die innovative Jobbörse, die Jobsuchende und Arbeitgeber zusammenbringt.
            ...
            <div className="flex gap-3">
              <a href="https://instagram.com/berufsgenie" target="_blank" rel="noopener noreferrer" className="hover:text-amber-400 transition-colors" aria-label="Instagram">
              ...
              <a href="https://tiktok.com/@berufsgenie" target="_blank" rel="noopener noreferrer" className="hover:text-amber-400 transition-colors" aria-label="TikTok">
              ...
              <a href="https://youtube.com/@berufsgenie" target="_blank" rel="noopener noreferrer" className="hover:text-amber-400 transition-colors" aria-label="YouTube">
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              ...
              <li><Link href="/jobs" className="text-amber-400 hover:text-amber-300 font-medium transition-colors">Alle Städte →</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-1.5 text-sm">
              <li><Link href="/ratgeber/bewerbungsschreiben-tipps" className="hover:text-white transition-colors">Bewerbung schreiben</Link></li>
              <li><Link href="/ratgeber/lebenslauf-erstellen" className="hover:text-white transition-colors">Lebenslauf erstellen</Link></li>
              <li><Link href="/ratgeber/vorstellungsgespraech-vorbereitung" className="hover:text-white transition-colors">Vorstellungsgespräch</Link></li>
              <li><Link href="/ratgeber/gehaltsverhandlung-tipps" className="hover:text-white transition-colors">Gehaltsverhandlung</Link></li>
              <li><Link href="/ratgeber/berufswechsel-quereinsteiger" className="hover:text-white transition-colors">Quereinsteiger</Link></li>
              <li><Link href="/ratgeber" className="text-amber-400 hover:text-amber-300 font-medium transition-colors">Alle Ratgeber →</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-10 pt-8 border-t border-stone-800">
          ...
          <div className="flex flex-wrap gap-3">
            <a href="https://ausbildungsgenie.de" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-stone-800 text-stone-300 hover:text-white hover:bg-stone-700 text-sm transition-colors">
              Ausbildungsgenie <ExternalLink className="h-3 w-3" />
            </a>
            <a href="https://werkstudentengenie.de" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-stone-800 text-stone-300 hover:text-white hover:bg-stone-700 text-sm transition-colors">
              Werkstudentengenie <ExternalLink className="h-3 w-3" />
            </a>
            <a href="https://praktikumsgenie.de" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-stone-800 text-stone-300 hover:text-white hover:bg-stone-700 text-sm transition-colors">
              Praktikumsgenie <ExternalLink className="h-3 w-3" />
            </a>
            <a href="https://minijobgenie.de" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-stone-800 text-stone-300 hover:text-white hover:bg-stone-700 text-sm transition-colors">
