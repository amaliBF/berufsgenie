...
export default function AppCTA({ title, description }: { title?: string; description?: string }) {
  return (
    <section className="bg-gradient-to-r from-amber-500 to-orange-600 rounded-2xl p-8 sm:p-10 text-white">
      <div className="flex flex-col sm:flex-row items-center gap-6">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          <a
            href="#"
            className="inline-flex items-center justify-center gap-2 bg-white text-amber-700 font-medium px-6 py-3 rounded-xl hover:bg-amber-50 transition-colors"
          >
            App Store
