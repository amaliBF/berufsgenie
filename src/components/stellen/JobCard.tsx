...
export default function JobCard({ job }: { job: JobListItem }) {
  ...
  return (
    <Link
      href={path}
      className="group block bg-white rounded-xl border border-gray-200 hover:border-amber-200 hover:shadow-lg hover:shadow-amber-100/50 transition-all p-5"
    >
      <div className="flex gap-4">
        ...
        <div className="flex-shrink-0">
          {job.videoThumbnail ? (
            ...
            <div className="w-20 h-20 rounded-lg bg-gradient-to-br from-amber-50 to-orange-50 flex items-center justify-center border border-amber-100">
